		...
		<div class="container h-100">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto h-100">
					...
					<li class="nav-item"><a class="nav-link active" href="${classpath }/admin/user/list">
							...
							<tbody>
								...
								<c:forEach var="user" items="${users }" varStatus="loop">
									<tr>
										...
										<td class="tm-product-name" data-category-id="${user.id }">${user.id }</td>
										<td class="tm-product-name" data-category-id="${user.id }">${user.name }</td>
										<td>${user.username }</td>
										<td><fmt:formatDate value="${user.createDate }"
												pattern="dd-MM-yyyy" /> -/- <fmt:formatDate
												value="${user.updateDate }" pattern="dd-MM-yyyy" /></td>
										...
										<td>
											...
											--> <a
											href="${classpath }/admin/category/delete/${user.id }">
	...
	<script>
		$(function() {
			$(".tm-product-name").on("click", function() {
				...
				window.location.href = "${classpath}/admin/user/edit/" + productId;
			});
		});
	</script>
</body>
