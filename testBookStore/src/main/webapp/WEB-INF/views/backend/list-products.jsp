	...
	<form action="${classpath }/admin/product/list" method="get">
		<div class="container mt-5">
			<div class="row tm-content-row">
				...
				<div class="col-md-2">
					<select class="form-control" id="publishserId" name="publisherId"
						style="margin-right: 10px; padding: 0 13px">
				...
				<div class="col-md-1">
					<button type="submit" id="btnSearch" name="btnSearch"
						class="btn btn-primary" style="padding-left: 8px">Search</button>
				</div>
								...
								<tbody>
									<c:forEach var="product" items="${products }" varStatus="loop">
										<tr>
											...
											<td class="tm-product-name" data-product-id="${product.id}">${product.id }</td>
											...
											<td>${product.userCreateProduct.username } / 
												${product.userUpdateProduct.username }</td>
											<td><fmt:formatDate value="${product.createDate }"
													pattern="dd-MM-yyyy" /> / <fmt:formatDate
													value="${product.updateDate }" pattern="dd-MM-yyyy" /></td>
...
-->
						...
						<!-- table container -->
						<a href="${classpath }/admin/product/add"
		...
		$(function() {
			$(".tm-product-name")
					.on(
							"click",	
							function() {
								window.location.href = "${classpath }/admin/product/edit/${product.id }";
							});
		});
	-->
	$(function() {
	    $(".tm-product-name").on("click", function() {
	        ...
	        window.location.href = "${classpath}/admin/product/edit/" + productId;
	    });
	});
	</script>
</body>
