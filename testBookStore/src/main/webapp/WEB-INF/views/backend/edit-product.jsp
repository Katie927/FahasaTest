		...
		<div class="row">
			<div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
				<div class="tm-bg-primary-dark tm-block tm-block-h-auto">
					...
					<sf:form action="${classpath }/admin/product/edit-save"
						...
						<div class="row tm-edit-product-row">
							...
							<div class="col-xl-6 col-lg-6 col-md-12">
								...
								<div class="form-group mb-3">
									<label for="name">Product Name </label> <sf:input path="name" id="name"
										name="name" type="text" class="form-control validate"  ></sf:input>
								</div>
								<div class="form-group mb-3">
									<label for="shortlDescription">Short Description</label>
									<sf:textarea path="shortDescription" class="form-control validate" rows="3" ></sf:textarea>
								</div>
								<div class="form-group mb-3">
									<label for="detailDescription">Detail Description</label>
									<sf:textarea path="detailDescription" class="form-control validate" rows="3" ></sf:textarea>
								</div>
								<div class="form-group mb-3">
								...
								<div class="form-group mb-3">
									<label for="publisher">Publish By</label>
									<sf:select path="publisher.id"
										class="custom-select tm-select-accounts" id="publisher">
										<sf:options items="${publishers }" itemValue="id"
											itemLabel="name"></sf:options>
									</sf:select>
								</div>
							...
							<div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
								<div class="tm-product-img-dummy mx-auto">
									<i class="fas fa-cloud-upload-alt tm-upload-icon"
										onclick="document.getElementById('avatarFile').click();"></i>
								</div>
								<div class="custom-file mt-3 mb-3">
									<input id="avatarFile" name="avatarFile" type="file" style="display: none;" /> <input
										type="button" class="btn btn-primary btn-block mx-auto"
										value="UPLOAD PRODUCT AVATAR"
							...
							<div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
								<div class="row">
									...
									<div class="form-group mb-3 col-xs-12 col-sm-6">
										<label for="price">Price </label> <sf:input path="price"
											id="price" name="price" type="text"
											class="form-control validate" ></sf:input>
										<!-- data-large-mode="true"  -->
									</div>
									<div class="form-group mb-3 col-xs-12 col-sm-6">
										<label for="salePrice">Sale price </label> <sf:input
											path="salePrice" id="salePrice" name="salePrice" type="text"
											class="form-control validate" ></sf:input>
										<!-- data-large-mode="true"  -->
									</div>
									<!-- create/update date -->
							...
							<div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
								<div class="row">
									<div class="form-group mb-3 col-xs-12 col-sm-6">
										<label for="inStock">Units In Stock </label> <sf:input path="inStock"
											id="inStock" name="inStock" type="text"
											class="form-control validate"  ></sf:input>
									</div>
								 ...
								 -->
									...
									<div class="form-group mb-3 col-xs-12 col-sm-6">
										...
										<sf:input path="createDate" class="form-control" type="date"
											...
											style="background-color: #54657d"></sf:input>
									</div>
									<div class="form-group mb-3 col-xs-12 col-sm-6">
										...
										<sf:input path="updateDate" class="form-control" type="date"
											id="updateDate" name="updateDate" readonly="true"
											style="background-color: #54657d"></sf:input>
									</div>
								</div>
							</div>
