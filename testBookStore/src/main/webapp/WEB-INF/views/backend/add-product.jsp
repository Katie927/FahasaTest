		...
		<div class="row">
			...
			<div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
				<div class="tm-bg-primary-dark tm-block tm-block-h-auto">
					...
					<sf:form action="${classpath }/admin/product/add-save"
						...
						<div class="row tm-edit-product-row">
							...
							<div class="col-xl-6 col-lg-6 col-md-12">
								...
								<div class="form-group mb-3">
									...
									<sf:textarea path="shortDescription"
										class="form-control validate" rows="3"></sf:textarea>
								</div>
								<div class="form-group mb-3">
								...
								<div class="form-group mb-4">
									...
									<label for="status">Active</label> <label for="isHot">&nbsp;&nbsp;&nbsp;&nbsp;</label>
							...
							<div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
								<div class="row">
									...
									<div class="form-group mb-3 col-xs-12 col-sm-6">
										<label for="price">Price </label> <input path="price"
							...
							<div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
								<div class="row">
									<div class="form-group mb-3 col-xs-12 col-sm-6">
										<label for="inStock">Units In Stock </label> <input
