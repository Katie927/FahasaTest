		...
		<div class="container h-100">
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mx-auto h-100">
					...
					<li class="nav-item"><a class="nav-link active" href="${classpath }/admin/category/list">
							...
							<tbody>
								...
								<c:forEach var="category" items="${categories }" varStatus="loop">
									<tr>
										...
										<td class="tm-product-name" data-category-id="${category.id }">${category.id }</td>
										<td class="tm-product-name" data-category-id="${category.id }">${category.name }</td>
										<td>${category.name }</td>
...
-->
					...
					<!-- table container -->
					<a href="${classpath }/admin/category/add"
	...
	<script>
		$(function() {
			$(".tm-product-name").on("click", function() {
				...
				window.location.href = "${classpath}/admin/category/edit/" + productId;
			});
		});
	</script>
</body>
