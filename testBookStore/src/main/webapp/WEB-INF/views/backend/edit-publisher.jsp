		...
		<div class="row">
			...
			<div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
				<div class="tm-bg-primary-dark tm-block tm-block-h-auto">
					<div class="row">
						<div class="col-12">
							<h2 class="tm-block-title d-inline-block">Edit publisher</h2>
						</div>
					</div>
					<sf:form action="${classpath }/admin/publisher/edit-save"
						...
						<div class="row tm-edit-product-row">
							...
							<div class="col-xl-6 col-lg-6 col-md-12">
								...
								<div class="form-group mb-3">
									<label for="name">Publisher Name </label> <sf:input path="name" id="name"
